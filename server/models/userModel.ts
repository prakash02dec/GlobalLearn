...
export interface IUser extends Document { // IUser is the interface for the user document. It is used to define the type of the user document
    name: string;
    email: string;
    password: string;
    avatar: {
...
userSchema.pre<IUser>("save", async function (next) { // this is a middleware that will run before saving the user
